    ...
    //Auto esenario2
       ...
       (b[1] == a[2] && a[1] == b[2] )){ //A y B son distintos pero tienen el sibolo del otro 
        ...
        if(b[1] == b[2] && a[1] != a[2]){//B son iguales pero A no
            ...
            document.getElementById(`${a[2]}${e}`).click() //el 2do de la pared del distinto es el primero del que falta
            document.getElementById(`${a[1]}2p${e}`).click() //el 1do de la pared del distinto es el segundo del que falta
        }
        if(a[1] == a[2] && b[1] != b[2]){//A son iguales pero B no
        
            document.getElementById(`${b[2]}${e}`).click() //el 2do de la pared del distinto es el primero del que falta
            document.getElementById(`${b[1]}2p${e}`).click() //el 1do de la pared del distinto es el segundo del que falta
        }
...
function esenario2(lado){
    ...
    if(a[1] == a[2] ){
        ...
        pasos.innerHTML = `<li>1. ${primero} manda <i class="symbol-sm ${a[1]}"></i> a ${segundo} y <i class="symbol-sm ${a[2]}"></i> a ${tercero}.<li>
                           <li>2. ${tercero} manda <i class="symbol-sm ${c[1]}"></i> a ${segundo} y <i class="symbol-sm ${c[2]}"></i> a ${primero}.<li>
                           <li>3. ${segundo} manda <i class="symbol-sm ${b[1]}"></i> a ${tercero} y <i class="symbol-sm ${b[2]}"></i> a ${primero}.<li><hr>
                           <li>Termina en <b>${primero}<b>. <li>`
